...
ALTER TABLE celery_taskmeta ENGINE=InnoDB;
ALTER TABLE celery_tasksetmeta ENGINE=InnoDB;
...
ALTER TABLE djcelery_crontabschedule ENGINE=InnoDB;
ALTER TABLE djcelery_intervalschedule ENGINE=InnoDB;
ALTER TABLE djcelery_periodictask ENGINE=InnoDB;
ALTER TABLE djcelery_periodictasks ENGINE=InnoDB;
ALTER TABLE djcelery_taskstate ENGINE=InnoDB;
ALTER TABLE djcelery_workerstate ENGINE=InnoDB;
...
ALTER TABLE djcelery_periodictask ADD FOREIGN KEY (crontab_id) REFERENCES djcelery_crontabschedule (id);
ALTER TABLE djcelery_periodictask ADD FOREIGN KEY (interval_id) REFERENCES djcelery_intervalschedule (id);
ALTER TABLE djcelery_taskstate ADD FOREIGN KEY (worker_id) REFERENCES djcelery_workerstate (id);