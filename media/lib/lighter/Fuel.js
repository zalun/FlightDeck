...
var Fuel = new Class({
	...
	initialize: function(code, options, wicks) {
		...
		if (!options.strict) {
			...
			matches.append(this.builder[options.matchType].pass(this.code, this)());
			...
			while ((match = delim.start.exec(this.code)) != null ) {
				...
				if ((endMatch = delim.end.exec(this.code)) != null ) {
					...
					matches.append(this.builder[options.matchType].pass([codeSeg, codeBeg], this)());
	...
	findMatches: function(code, offset) {
		...
		Object.each(this.rules, function(regex, rule) {
