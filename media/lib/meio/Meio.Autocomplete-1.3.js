...
(function(global){
	...
	Meio.Autocomplete.Select.One = new Class({
		...
		replaceSelect: function(){
			...
			if(optionValue != null) this.field.set('value', selectedOption.get('html'));
		...
		createDataArray: function(){
			...
			for(var i = 0, selectOption, optionValue; selectOption = selectOptions[i++];){
				...
				if(optionValue != null) data.push({value: optionValue, text: selectOption.innerHTML});
			}
			return data;
		},
	...
	if(global.Meio != null) Object.append(global.Meio, Meio);
