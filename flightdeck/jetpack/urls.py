...
urlpatterns = patterns('jetpack.views',
    ...
    # browsing packages
    url(r'^addons/$', 'package_browser', {'type': 'a'},
        name='jp_browser_addons'),
    url(r'^libraries/$', 'package_browser', {'type': 'l'},
    ...
    url(r'^addon/(?P<id>[-\w]+)/latest/$',
        'package_details', {'type': 'a', 'latest': True},
        name='jp_addon_latest'),
    url(r'^library/(?P<id>[-\w]+)/latest/$',
        'package_details', {'type': 'l', 'latest': True},
    ...
    url(r'^addon/edit/(?P<id>[-\w]+)/latest/$',
        'package_edit', {'type': 'a', 'latest': True},
        name='jp_addon_edit_latest'),
    url(r'^library/edit/(?P<id>[-\w]+)/latest/$',
        'package_edit', {'type': 'l', 'latest': True},
